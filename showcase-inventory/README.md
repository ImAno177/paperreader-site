...
| `../public/showcase/emulator-reader-cgp.png` | Local emulator cached CGP-Tuning reader with normalization warning | Docs |
...
The emulator captures above are deliberately single-state evidence, not Light/Dark pairs. The
corresponding host-side audit records provider calls, cache structure, asset counts, and failure
behavior in the Android repository's `docs/TESTING.md`.
